...
public class Constants {
     ...
     */
    public static float THUMBNAIL_RATIO = 0.6f; // Default 0.3f
     ...
     */
    public static float PART_SIZE = 384; // Default 256

    /**
     * Part of document above and below screen that should be preloaded, in dp
     */
    public static int PRELOAD_OFFSET = 30; // Default 20
    ...
    public static class Cache {
         ...
         */
        public static int CACHE_SIZE = 150; // Default 150
        public static int THUMBNAILS_CACHE_SIZE = 10; // Default 8
    }
